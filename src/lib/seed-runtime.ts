...
const OLD_PRODUCT_PLACEHOLDER_IMAGES = [
  "/assets/img/product/product_1_1.jpg",
  "/assets/img/product/product_1_2.jpg",
  "/assets/img/product/product_1_3.jpg",
  "/assets/img/product/product_1_4.jpg",
  "/assets/img/product/product_1_5.jpg",
  "/assets/img/product/product_1_6.jpg",
  "/assets/img/product/product_1_7.jpg",
  "/assets/img/product/product_1_8.jpg",
  "/assets/img/product/product_1_9.jpg",
];

const OLD_BLOG_PLACEHOLDER_IMAGES = [
  "/assets/img/blog/blog-grid-1.jpg",
  "/assets/img/blog/blog-grid-2.jpg",
  "/assets/img/blog/blog-grid-3.jpg",
  "/assets/img/blog/blog-grid-4.jpg",
  "/assets/img/blog/blog-grid-5.jpg",
  "/assets/img/blog/blog-grid-6.jpg",
  "/assets/img/blog/blog-grid-7.jpg",
  "/assets/img/blog/blog-grid-8.jpg",
];

const PRODUCT_REPAIR_MAP: Record<string, string> = {
  "omega-3-salmon": "/assets/img/home/Omega-3.jpg",
  calcium: "/assets/img/home/calmag.jpg",
  "vitamin-c-1000mg": "/assets/img/home/vit-c-1000.jpg",
  biotin: "/assets/img/home/herbal.jpg",
  "kids-multivitamin": "/assets/img/home/home-4.jpg",
  glucosamine: "/assets/img/home/sunvit-d3.jpg",
  collagen: "/assets/img/home/omega-369.jpg",
  "red-yeast-rice": "/assets/img/home/dha.jpg",
  "prenatal-dha": "/assets/img/home/home-1.jpg",
};

const BLOG_REPAIR_MAP: Record<string, string> = {
  "keep-loved-ones-healthy": "/assets/img/home/blog-home-1.jpg",
  "choose-right-doctor": "/assets/img/home/blog-home-2.jpg",
  "essential-health-screenings": "/assets/img/home/blog-home-3.jpg",
  "effective-time-management": "/assets/img/home/blog-home-4.jpg",
  "enhancing-team-collaboration": "/assets/img/home/blog-home-1.jpg",
  "essential-screenings-2": "/assets/img/home/blog-home-2.jpg",
  "keep-loved-ones-2": "/assets/img/home/blog-home-3.jpg",
  "choose-right-doctor-2": "/assets/img/home/blog-home-4.jpg",
};

export async function resetAllTables(prisma: DbClient) {
...
export async function repairPlaceholderImages(prisma: DbClient) {
  let productsUpdated = 0;
  for (const [slug, image] of Object.entries(PRODUCT_REPAIR_MAP)) {
    const res = await prisma.product.updateMany({
      where: {
        slug,
        image: { in: OLD_PRODUCT_PLACEHOLDER_IMAGES },
      },
      data: { image },
    });
  ...
  let blogsUpdated = 0;
  for (const [slug, image] of Object.entries(BLOG_REPAIR_MAP)) {
    const res = await prisma.blogPost.updateMany({
      where: {
        slug,
        image: { in: OLD_BLOG_PLACEHOLDER_IMAGES },
      },
      data: { image },
    });
    blogsUpdated += res.count;
  }

  return { productsUpdated, blogsUpdated };
}

export async function seedCurrentData(prisma: DbClient, options?: { reset?: boolean }) {
  ...
  const catMap = Object.fromEntries(productCategories.map((c: { slug: string; id: number }) => [c.slug, c.id]));
    ...
    data: [
      {
        ...
        slug: "omega-3-salmon",
        image: "/assets/img/home/Omega-3.jpg",
        images: [
        ...
        dosage: "1-2 kapsul per hari setelah makan atau sesuai anjuran dokter.",
        sku: "SQ-OM3-60",
      ...
      },
      {
        ...
        slug: "calcium",
        image: "/assets/img/home/calmag.jpg",
        images: [
          "/assets/img/product/single-image-1.jpg",
          "/assets/img/product/single-image-2.jpg",
          "/assets/img/product/single-image-3.jpg",
      ...
      },
      {
        ...
        image: "/assets/img/home/vit-c-1000.jpg",
        images: [
          "/assets/img/product/single-image-1.jpg",
          "/assets/img/product/single-image-2.jpg",
          "/assets/img/product/single-image-3.jpg",
      ...
      },
      {
        ...
        slug: "biotin",
        image: "/assets/img/home/herbal.jpg",
        images: [
          "/assets/img/product/single-image-1.jpg",
          "/assets/img/product/single-image-2.jpg",
          "/assets/img/product/single-image-3.jpg",
      ...
      },
      {
        ...
        composition: "Vitamin A, C, D3, E, B Complex, Zinc, Iron, Calcium.",
      ...
      },
      {
        ...
        slug: "glucosamine",
        image: "/assets/img/home/sunvit-d3.jpg",
        images: [
          "/assets/img/product/single-image-1.jpg",
          "/assets/img/product/single-image-2.jpg",
          "/assets/img/product/single-image-3.jpg",
        ...
        composition: "Glucosamine Sulfate 1500mg, Chondroitin Sulfate, MSM.",
        dosage: "1 tablet per hari setelah makan.",
        sku: "SQ-GLU-60",
      ...
      },
      {
        ...
        slug: "collagen",
        image: "/assets/img/home/omega-369.jpg",
        images: [
          "/assets/img/product/single-image-1.jpg",
          "/assets/img/product/single-image-2.jpg",
          "/assets/img/product/single-image-3.jpg",
      ...
      },
      {
        ...
        slug: "prenatal-dha",
        image: "/assets/img/home/home-1.jpg",
        images: [
          "/assets/img/product/single-image-1.jpg",
          "/assets/img/product/single-image-2.jpg",
          "/assets/img/product/single-image-3.jpg",
  ...
  const blogCategories = await Promise.all([
    prisma.blogCategory.create({ data: { slug: "tips-sehat", title: "Tips Sehat", sortOrder: 1 } }),
    prisma.blogCategory.create({
      data: { slug: "imun-daya-tahan-tubuh", title: "Imun & Daya Tahan Tubuh", sortOrder: 2 },
    }),
    prisma.blogCategory.create({ data: { slug: "nutrisi-gizi", title: "Nutrisi & Gizi", sortOrder: 3 } }),
    prisma.blogCategory.create({ data: { slug: "panduan-suplemen", title: "Panduan Suplemen", sortOrder: 4 } }),
    prisma.blogCategory.create({ data: { slug: "kecantikan", title: "Kecantikan", sortOrder: 5 } }),
  ]);

  const blogCatMap = Object.fromEntries(blogCategories.map((c: { slug: string; id: number }) => [c.slug, c.id]));
    ...
    data: [
      {
        ...
        image: "/assets/img/home/blog-home-1.jpg",
        author: "Jane Doe",
        excerpt:
      ...
      {
        title: "How to Choose the Right Primary Care Doctor for Your Need",
        slug: "choose-right-doctor",
        image: "/assets/img/home/blog-home-2.jpg",
      ...
      },
      {
        ...
        image: "/assets/img/home/blog-home-3.jpg",
        author: "Robin Son",
        excerpt:
      ...
      },
      {
        ...
        image: "/assets/img/home/blog-home-4.jpg",
        author: "Jenny Lee",
        excerpt:
      ...
      },
      {
        ...
        excerpt: "Finding the right doctor is key to your healthcare journey.",
        content:
  ...
  const defaultSettings: Record<string, string> = {
    ...
    home_about_section: JSON.stringify({
      ...
      paragraph:
        "Sea-Quill menghadirkan suplemen kesehatan terpercaya, dibuat dengan standar internasional dan inovasi terkini. Kami berkomitmen mendukung Anda dan keluarga dalam menjaga daya tahan tubuh dan kualitas hidup setiap hari.",
      checklist: [
    ...
    home_service_list: JSON.stringify({
      ...
      paragraph:
        "Dapatkan manfaat optimal dari produk-produk Sea-Quill, diproses dengan teknologi terbaik dan selalu mengutamakan kualitas, keamanan, dan edukasi untuk keluarga Indonesia.",
      items: [
        {
          icon: "/assets/img/icon/service_1_1.svg",
    ...
    home_product_section: JSON.stringify({
      ...
      paragraph:
        "Temukan suplemen terbaik Sea-Quill untuk mendukung kesehatan keluarga Anda. Setiap produk terjamin keaslian, kualitas, dan sudah BPOM serta Halal.!",
    }),
    home_blog_section: JSON.stringify({
      subTitle: "Artikel Kesehatan",
      heading: "Blog & Berita ! Sea-Quill",
      paragraph:
        "Temukan update seputar produk, edukasi, dan tren kesehatan terbaru langsung dari Sea-Quill.!",
    }),
    ...
    tentang_project_slider: JSON.stringify({
      ...
      paragraph:
        "Sea-Quill adalah merek suplemen kesehatan terkemuka yang telah dipercaya masyarakat Indonesia untuk mendukung gaya hidup sehat. Dengan formulasi berkualitas tinggi, bahan alami, dan sertifikasi BPOM serta Halal, Sea-Quill selalu berkomitmen menghadirkan inovasi dan manfaat nyata bagi setiap keluarga Indonesia.",
      sideParagraph:
        "We have world class lab assistants. We are equipped with best medical services & reagents. We ensure best quality findings.",
      items: [
        {
      ...
      items: [
        {
          ...
          title: "@seaquill.id",
          description:
            "Dapatkan info promo, edukasi kesehatan, dan inspirasi gaya hidup sehat langsung dari Instagram resmi Sea-Quill.",
        ...
        },
        {
          ...
          description:
            "Like dan follow Facebook Sea-Quill untuk update berita, tips kesehatan, dan testimoni pengguna.",
        ...
        },
        {
          ...
          title: "@seaquill.id",
          description:
            "Saksikan konten seru, tips kesehatan, dan edukasi suplemen dengan format video di TikTok Sea-Quill.",
      ...
      items: [
        {
          ...
          description:
            "Dapatkan produk Sea-Quill original dan promo menarik langsung dari official store kami di Tokopedia.",
        ...
        },
        {
          ...
          description:
            "Cari produk Sea-Quill dan nikmati kemudahan belanja serta voucher di Shopee.",
        ...
        },
        {
          ...
          description:
            "Nikmati pengalaman belanja produk Sea-Quill yang aman dan mudah, dengan promo eksklusif dan layanan pengiriman cepat hanya di Lazada Official Store kami.",
        ...
        },
        {
          ...
          description:
            "Belanja langsung lewat TikTok Shop Sea-Quill dan dapatkan penawaran spesial serta flash sale selama live streaming bersama kami!",
  ...
  const heroSlideGroup = await prisma.heroSlideGroup.create({
    data: {
      ...
      description: "Default active hero group",
      active: true,
    },
  });
  ...
  await Promise.all(brandData.map((b) => prisma.brandPartner.create({ data: { ...b, active: true } })));
  ...
  await Promise.all(galleryData.map((g) => prisma.galleryItem.create({ data: { ...g, active: true } })));
  ...
  const promoData = [
    ...
    },
    {
      ...
      description:
        "Setiap pembelian 2 botol multivitamin Seaquill, dapatkan 1 botol gratis. Berlaku hanya untuk produk tertentu selama Agustus 2025.",
    ...
    },
    {
      ...
      description:
        "Dapatkan paket bundling Seaquill dengan harga spesial! Kombinasi produk pilihan untuk kebutuhan kesehatan keluarga Anda.",
      image: "/assets/img/gallery/gallery_1_2.jpg",
      sortOrder: 5,
    },
  ];
  await Promise.all(promoData.map((p) => prisma.promoItem.create({ data: { ...p, active: true } })));

  const eventData = [
    {
      title: 'Live Streaming: "Rahasia Imun Kuat Bersama Nutritionist"',
      description:
        "Jangan lewatkan sesi live edukasi bareng pakar nutrisi Seaquill. Ada hadiah voucher untuk penanya terbaik!",
    ...
    },
    {
      ...
      description:
        "Main quiz live di Tokopedia Play, menangkan produk Seaquill gratis untuk 5 peserta tercepat!",
    ...
    },
    {
      ...
      description:
        "Ikuti Fun Walk Seaquill di Jakarta dan dapatkan pemeriksaan kesehatan gratis serta goody bag menarik!",
  ...
  await Promise.all(eventData.map((e) => prisma.eventItem.create({ data: { ...e, active: true } })));
  ...
  await Promise.all(mediaData.map((m) => prisma.mediaFile.create({ data: m })));

  const defaultForm = await prisma.form.create({
    data: {
      name: "Contact Form",
      slug: "contact-form",
      description: "Form kontak default untuk website Sea-Quill",
      fields: JSON.stringify([
        { id: "name", type: "text", name: "name", label: "Nama", required: true, placeholder: "Nama lengkap Anda" },
        { id: "email", type: "email", name: "email", label: "Email", required: true, placeholder: "email@contoh.com" },
        { id: "phone", type: "text", name: "phone", label: "Nomor HP", required: false, placeholder: "+62 8xx-xxxx-xxxx" },
        { id: "message", type: "textarea", name: "message", label: "Pesan", required: true, placeholder: "Tuliskan pertanyaan Anda" },
      ]),
  ...
  await prisma.activityLog.create({
    data: {
      action: "create",
      entity: "seed",
      entityId: defaultForm.id,
      entityName: "Database seeded",
      details: "Initial seed executed for all tables",
      userId: admin.id,
    },
  });
  ...
  return {
    ...
    blogPosts: 8,
    siteSettings: Object.keys(defaultSettings).length,
    brandPartners: brandData.length,
    galleryItems: galleryData.length,
    promoItems: promoData.length,
    eventItems: eventData.length,
